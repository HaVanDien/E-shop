...
public class MainController {
    ...
    public String productListMan(ModelMap mm) throws ClassNotFoundException, SQLException {
        ...
        // get List product
    @RequestMapping(value = "/productListSport", method = RequestMethod.GET)
    public String getProductListSport(ModelMap mm) throws ClassNotFoundException, SQLException {
        List<product> prodListSport = dao.getProListSport();
        mm.put("proListSport", prodListSport);
        return "productListSport";
    }
    
    // get List product
    @RequestMapping(value = "/productListSport", method = RequestMethod.POST)
    public String productListSport(ModelMap mm) throws ClassNotFoundException, SQLException {
        List<product> prodListSport = dao.getProListSport();
        mm.put("proListSport", prodListSport);
        return "productListSport";
    }
