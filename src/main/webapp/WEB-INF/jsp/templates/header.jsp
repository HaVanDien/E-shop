    ...
    <section class="navbar main-menu">
        <div class="navbar-inner main-menu">
            <a href="/e-shopper" class="logo pull-left"><img
                    src="/e-shopper/assets/themes/images/logo1.png" class="site_logo" alt=""></a>
            <nav id="menu" class="pull-right">
                <ul>
                    ...
                    <li><a href="./productListSport.html">Sport</a>
                        <ul>
                    ...
                    <li><a href="./topSell.html">Top Seller</a></li>
                </ul>
            </nav>
        </div>
    </section>
