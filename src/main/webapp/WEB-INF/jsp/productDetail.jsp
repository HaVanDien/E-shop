            ...
            <div class="row">
                <div class="span4">
                    ...
                    <ul class="thumbnails small">								
                        <li class="span1">
                            <a href="${prod.pro_img_link}" class="thumbnail" data-fancybox-group="group1" title="Description 2"><img src="${prod.pro_img_link}" alt=""></a>
                        </li>								
                        <li class="span1">
                            <a href="${prod.pro_img_link}" class="thumbnail" data-fancybox-group="group1" title="Description 3"><img src="${prod.pro_img_link}" alt=""></a>
                        </li>													
                        <li class="span1">
                            <a href="${prod.pro_img_link}" class="thumbnail" data-fancybox-group="group1" title="Description 4"><img src="${prod.pro_img_link}" alt=""></a>
                        </li>
                        <li class="span1">
                            <a href="${prod.pro_img_link}" class="thumbnail" data-fancybox-group="group1" title="Description 5"><img src="${prod.pro_img_link}" alt=""></a>
                        </li>
                    </ul>
                </div>
                <div class="span5">
                    <address>
                        ...
                        <strong>Product Name:</strong> <span>Product ${prod.pro_name}</span><br>
