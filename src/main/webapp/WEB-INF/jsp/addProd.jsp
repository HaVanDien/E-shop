                    ...
                    <div class="panel-body">
                        <form role="form" action="/e-shopper/admin/addNewProd" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputPassword1" name="prod_category" value="${pro_category}">
                                 <c:choose>
                                    <c:when test="${proCateVali==1}">
                                        <div class="error" style="color: red">You have to enter product category here.</div>
                                    </c:when>
